      ...
      <div align="center">
        <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
          <tr class="BigBrainzStyle">
            <td><div align="center">
              <p class="boxQuote">Contact Info</p>
              <p class="boxQuote">&nbsp;</p>
              <p class="notice2">Please note--we are still offering our base version free to consumers<br />
                ONLY if it does not create a burden for our tech support people.<br />
                Please do not contact us for help with the free version or we will lose<br />
                the opportunity of providing this amazing free tool for folks.</p>
              <p class="notice2">Thank you!</p>
              <p class="text"><br />
              </p>
              <p class="text">If you need support with something other than the free version please please  email<span class="bullet"> <a href="mailto:info@ImagineLearning.com">support@ImagineLearning.com</a></span></p>
              <p class="text">Or give us a call at 866-377-5071 
                <noscript></noscript>
