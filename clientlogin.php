...
<title>Big Brainz Thanks</title>

<script language="JavaScript" type="text/javascript">
<!-- Overture Services Inc. 07/15/2003
var cc_tagVersion = "1.0";
var cc_accountID = "1534624892";
var cc_marketID =  "0";
...
<script src="/Assets/Scripts/urchin.js" type="text/javascript"></script>
<script type="text/javascript">
_uacct = "UA-94233-1";
urchinTracker();
</script>
...
<!-- InstanceBeginEditable name="Edit Region 1" -->
      ...
      <div align="center">
		...
		<tr> 
          <td class="mincart" bgcolor="#F0F0F0" align="center"><span style="font-family:Verdana">&raquo;</span> <a class="ectlink mincart" href="http://www.bigbrainz.com/cart.php?mode=login&amp;refurl=%2Fclientlogin.php"><strong>Login</strong></a></td>
        </tr>
      </table>                <br />
                <script type="text/javascript">
/* <![CDATA[ */
...
/* ]]> */
	  ...
	  <table class="cobtbl" width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr>
		  <td class="cobhl cobhdr" align="center" height="32" colspan="2"><strong>Customer Account</strong></td>
		</tr>
		<tr>
		  <td class="cobll" align="center" height="32" colspan="2"><p>&nbsp;</p><p>You must be logged in to access your customer account.</p>
		  <p><input type="button" value="Login" class="login" onclick="document.location=(((ECTbh=document.getElementsByTagName('base')).length>0?ECTbh[0].href+'/':'')+'cart.php?mode=login&amp;refurl=%2Fclientlogin.php').replace(/([^:]\/)\/+/g,'$1')" /></p>
		  <p>&nbsp;</p>
		  </td>
		</tr>
      </table>
      ...
      <div align="center">
        ...
        <script language="JavaScript" type="text/javascript">
<!--
var google_conversion_id = 1069441077;
...
//-->
        ...
        <noscript>
        <img height="1" width="1" border="0" src="https://www.googleadservices.com/pagead/conversion/1069441077/?value=$ordTotal&amp;label=Purchase&amp;script=0" />
        </noscript>         
        
        <!-- START MSN adCenter Code -->
        <script>
microsoft_adcenterconversion_domainid = 1686;
 microsoft_adcenterconversion_cp = 5050; 
      </script>
        <script src="https://0.r.msn.com/scripts/microsoft_adcenterconversion.js"></script>
        <noscript>
          <img width="1" height="1" src="https://1686.r.msn.com/?type=1&amp;cp=1"/>
          </noscript>
        <a href="http://advertising.msn.com/MSNadCenter/LearningCenter/adtracker.asp" target="_blank">::adCenter::</a>
        <!-- END MSN adCenter Code -->
