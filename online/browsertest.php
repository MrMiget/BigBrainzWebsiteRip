<form action="" method="post" name="form_320849343" >
<input type="hidden" name="LaunchGame" value="false" />
</form>
<form action="" method="post" name="form_1050393435" >
</form>
    ...
    <td colspan="2" align="center" valign="middle"><div align="left">
      <table width="100%" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td valign="middle"><div align="center"> <!-- InstanceBeginEditable name=" " --><span class="notice">Incompatible Browser</span> <!-- InstanceEndEditable --> </div></td>
        </tr>
      </table>
    </div></td>
  </tr>
      ...
      <div align="center">
        <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
          <tr class="BigBrainzStyle">
            <td><div align="center">
            	<form action="" method="post" name="form_1034121316" ><a href='javascript:document.form_1034121316.submit()' class="return" >Return to Class</a><input type="hidden" name="Action" value="GamePage" /><input type="hidden" name="CurrentRegionType" value="GameSelected" /></form>
              <p class="bullet">Many apologies, but currently the only browsers we support are:</p>
              <p class="bullet"> Internet Explorer 6, 7, or 8 and Safari 3</p>
              <p class="bullet">We will be adding Firefox soon.  </p>
